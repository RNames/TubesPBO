...
/**
 * Panel admin untuk mengelola data izin keluar siswa.
 * Fitur: tabel data, filter kelas, search nama, pagination 25/page, approve, delete.
 */
public class ExitPermitPanel extends JPanel {
    ...
    private List<StudentPermit> allPermits;
    private List<StudentPermit> filteredPermits;
    private static final int PAGE_SIZE = 25;
    private int currentPage = 0;

    public ExitPermitPanel() {
        initComponents();
        loadData();
    }
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Izin Keluar");
        ...
        // === CENTER: Table ===
        String[] columns = {"No", "Nama", "Kelas", "Alasan", "Waktu Keluar", "Kembali", "Durasi (Mnt)", "Status", "Disetujui Oleh"};
    ...
    public void loadData() {
        ...
        new SwingWorker<List<StudentPermit>, Void>() {
            ...
            protected List<StudentPermit> doInBackground() {
                return permitService.getPermitsByType(schoolId, PermitType.EXIT_PERMIT);
            }
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(ExitPermitPanel.this,
    ...
    private void renderPage() {
        ...
        for (int i = start; i < end; i++) {
            ...
            String returnTime = p.getReturnTimestamp() > 0 ? DateUtils.formatTime(p.getReturnTimestamp()) : "-";
    ...
    private void approvePermit(int tableRow) {
        ...
        int confirm = JOptionPane.showConfirmDialog(this,
            "Approve izin keluar untuk " + permit.getStudentName() + "?",
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            new SwingWorker<Void, Void>() {
                ...
                protected void done() {
                    try {
                        get();
                        JOptionPane.showMessageDialog(ExitPermitPanel.this, "Data berhasil dihapus!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
                        loadData();
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(ExitPermitPanel.this, "Gagal menghapus: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }.execute();
        }
