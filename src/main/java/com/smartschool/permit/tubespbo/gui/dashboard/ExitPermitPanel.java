...
public class ExitPermitPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        // --- TABLE ---
        String[] columns = {"No", "Nama", "Kelas", "Alasan", "Waktu Keluar", "Durasi (Menit)", "Status", "Disetujui Oleh"};
        ...
        new SwingWorker<List<StudentPermit>, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(ExitPermitPanel.this, "Error memuat data: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }.execute();
    }
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            new SwingWorker<Void, Void>() {
                ...
                protected void done() {
                    try {
                        get();
                        JOptionPane.showMessageDialog(ExitPermitPanel.this, "Berhasil di-approve!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
                        loadData();
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(ExitPermitPanel.this, "Gagal approve: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }.execute();
        }
